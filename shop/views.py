...
def home(request):
	if request.method == "GET":
		...
		path = request.path
		return render(request, "shop/home.html", {"games": games, 'path': path})
	else:
...
def game_info(request, game_id):
	if request.method == "GET":
		...
		sid = "ShopApplication"
		amount = game.price
		success = "https://supergameshop.herokuapp.com/payment/success/?game_id={}".format(game_id)
		cancel = "https://supergameshop.herokuapp.com/payment/cancel"
		error = "https://supergameshop.herokuapp.com/payment/error"
